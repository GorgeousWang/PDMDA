...
if __name__ == "__main__":
    ...
    dir_input = ('./data/miRNAdisease-HMDD2.0-task2/')


    CV_mirnaid_list = load_strlist(dir_input + 'CVmiRNA_all_and_un_types.txt')
    CV_diseaseid_list = load_strlist(dir_input + 'CVdisease_all_and_un_types.txt')
    associations = load_tensor(dir_input + 'label_all_and_un_types', torch.LongTensor)
    ...
    for kk in range(1):
        """Output files."""
        file_output = './output/PDMDA-task2-result.txt'
